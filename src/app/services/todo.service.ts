  ...
  ngOnInit() {
   ...
   fetchFromLocalStorage() {
    //  this.todos = this.storageService.getValue<Todo[]>(TodoService.TodoStorageKey) || [];
      this.httpClient.get<Todo[]>('http://localhost:3000/posts').subscribe(data => {this.todos = data;
   ...
   addTodo(content: string){
    ...
    this.httpClient.post<Todo>("http://localhost:3000/posts",newTodo,this.httpOptions).subscribe(data => {this.todos.unshift(data);this.updateToLocalStorage();
  });
